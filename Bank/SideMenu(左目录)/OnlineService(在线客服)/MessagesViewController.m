...
- (void)viewDidLoad
{
     ...
     */
    self.senderId = kJSQAvatarIdSquires;
    self.senderDisplayName = kJSQAvatarDisplayNameSquires;
...
- (void)receiveMessagePressed:(UIBarButtonItem *)sender
{
    ...
    if (!copyMessage) {
        copyMessage = [JSQMessage messageWithSenderId:kJSQAvatarIdJobs
                                          displayName:kJSQAvatarDisplayNameJobs
                                                 text:@"First received!"];
    }
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [[JSQSystemSoundPlayer sharedPlayer] playSoundWithFilename:@"message_received"
                      ...
                      date:(NSDate *)date
{
    ...
    [[JSQSystemSoundPlayer sharedPlayer] playSoundWithFilename:@"message_sent"
                                                 fileExtension:kJSQSystemSoundTypeAIFF
                                                    completion:^{
