...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.avatars = @{ kJSQAvatarIdSquires : jsqImage,
                          kJSQAvatarIdCook : cookImage,
                          kJSQAvatarIdJobs : jobsImage,
                          kJSQAvatarIdWoz : wozImage };
        
        
        self.users = @{ kJSQAvatarIdJobs : kJSQAvatarDisplayNameJobs,
                        kJSQAvatarIdCook : kJSQAvatarDisplayNameCook,
                        kJSQAvatarIdWoz : kJSQAvatarDisplayNameWoz,
                        kJSQAvatarIdSquires : kJSQAvatarDisplayNameSquires };
...
- (void)loadFakeMessages
{
    ...
    self.messages = [[NSMutableArray alloc] initWithObjects:
                     [[JSQMessage alloc] initWithSenderId:kJSQAvatarIdSquires
                                        senderDisplayName:kJSQAvatarDisplayNameSquires
                                                     date:[NSDate distantPast]
                                                     text:@"Welcome to JSQMessages: A messaging UI framework for iOS."],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQAvatarIdWoz
                                        senderDisplayName:kJSQAvatarDisplayNameWoz
                                                     date:[NSDate distantPast]
                     ...
                     [[JSQMessage alloc] initWithSenderId:kJSQAvatarIdJobs
                     ...
                     [[JSQMessage alloc] initWithSenderId:kJSQAvatarIdCook
                                        senderDisplayName:kJSQAvatarDisplayNameCook
                                                     date:[NSDate date]
    ...
    if ([NSUserDefaults longMessageSetting]) {
        JSQMessage *reallyLongMessage = [JSQMessage messageWithSenderId:kJSQAvatarIdSquires
                                                            displayName:kJSQAvatarDisplayNameSquires
...
- (void)addPhotoMediaMessage
{
    ...
    JSQMessage *photoMessage = [JSQMessage messageWithSenderId:kJSQAvatarIdSquires
                                                   displayName:kJSQAvatarDisplayNameSquires
                                                         media:photoItem];
...
- (void)addLocationMediaMessageCompletion:(JSQLocationMediaItemCompletionBlock)completion
{
    ...
    JSQMessage *locationMessage = [JSQMessage messageWithSenderId:kJSQAvatarIdSquires
                                                      displayName:kJSQAvatarDisplayNameSquires
                                                            media:locationItem];
...
- (void)addVideoMediaMessage
{
    ...
    JSQMessage *videoMessage = [JSQMessage messageWithSenderId:kJSQAvatarIdSquires
                                                   displayName:kJSQAvatarDisplayNameSquires
                                                         media:videoItem];
